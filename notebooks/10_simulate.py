"""
nohup python -m notebooks.10_simulate > notebooks/10_out.txt 2>&1 &
"""
import pickle
import sinter
...
if __name__ == '__main__':
    ...
    stats_surface = sinter.collect(
        ...
        max_errors=500,
        print_progress=True,
        save_resume_filepath='notebooks/data/10_results_TMP_Z',
    )
    ...
    with open('notebooks/data/10_results_Z.pkl', 'wb') as f:
        pickle.dump(stats, f)