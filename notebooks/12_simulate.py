"""
nohup python -m notebooks.12_simulate > notebooks/12_out.txt 2>&1 &
"""
import pickle
import sinter
...
if __name__ == '__main__':
    ...
    stats_surface = sinter.collect(
        ...
        max_errors=500,
        print_progress=True,
        save_resume_filepath='notebooks/data/12_results_TMP',
    )
    ...
    with open('notebooks/data/12_results.pkl', 'wb') as f:
        pickle.dump(stats, f)